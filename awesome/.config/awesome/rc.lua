...
local function set_wallpaper(s)
    local wallpaper = os.getenv("HOME") .. "/dotfiles/wallpapers/animeincircle.png"
...
globalkeys = gears.table.join(
  ...
  -- movement HJKL
    awful.key({ modkey, "Control" }, "j", function () awful.client.focus.bydirection("down")
        if client.focus then client.focus:raise() end
    end),
    awful.key({ modkey, "Control" }, "k", function () awful.client.focus.bydirection("up")
        if client.focus then client.focus:raise() end
    end),
    awful.key({ modkey, "Control" }, "h", function () awful.client.focus.bydirection("left")
        if client.focus then client.focus:raise() end
    end),
    awful.key({ modkey, "Control" }, "l", function () awful.client.focus.bydirection("right")
        if client.focus then client.focus:raise() end
    end),

    -- Move client windows
    awful.key({ modkey, "Shift", "Control" }, "h", function () awful.client.swap.bydirection("left") end,
              {description = "move client left", group = "client"}),
    awful.key({ modkey, "Shift", "Control" }, "j", function () awful.client.swap.bydirection("down") end,
              {description = "move client down", group = "client"}),
    awful.key({ modkey, "Shift", "Control" }, "k", function () awful.client.swap.bydirection("up") end,
              {description = "move client up", group = "client"}),
    awful.key({ modkey, "Shift", "Control" }, "l", function () awful.client.swap.bydirection("right") end,
    ...
    -- awful.key({ modkey, "Shift", "Control" }, "h", function () awful.client.swap.byidx( -1)    end,
    ...
    awful.key({ modkey, "Control"  }, "s", function () awful.spawn(browser) end,
  ...
  -- resize windows
    ...
    awful.key({ modkey, "Mod1", "Control" }, "h",     function () awful.tag.incmwfact(-0.03)          end,
...
client.connect_signal("manage", function (c)
  ...
  -- rounded corners
    ...
    gears.shape.rounded_rect(cr, width, height, 10)  -- 10 is the corner radius, change as needed
    end
